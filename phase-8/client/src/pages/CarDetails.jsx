    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg:col-span-2'>
          ...
          <div className='space-y-6'>
            <div>
              ...
              <p className='text-grayy-500 text-lg'>{car.category}. {car.year}</p>
            </div>
        ...
        <form onSubmit={handleSubmit} className=' shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          <p className='flex items-center justify-center text-2xl text-gray-800 font-semibold'>{currency} {car.pricePerDay} <span className='text-base text_gray-400 font-normal'> per day</span></p>
          <hr className='border-borderColor my-6' />
